//John Maurer
//A class that uses the PlayingCard class to create a Deck object, with 52 unique cards. Also has handy methods for shuffling and stuff
...
public class Deck {
	...
	public void shuffle() {
		int firstIndex = 0;
		int secondIndex = 0; //these two indices will serve as the two cards whose positions will be exchanged
		
		for(int i = 0; i < 500; i++) { //to ensure good shuffling, I give the random number generator a chance to shuffle every card. Its a basic shuffling method, but hopefully 200 iterations will shuffle the cards nicely
